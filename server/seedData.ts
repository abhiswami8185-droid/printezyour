...
export const initialProducts: Product[] = [
  ...
  },
  {
    ...
    basePrice: 300,
    priceType: 'quantity_tiered',
    minQuantity: 20, // sq ft
    quantityTiers: [
      { minQty: 20, unitPrice: 15.0 }, // 15 INR per sq ft
...
export const initialInventory: InventoryItem[] = [
  { id: 'inv-1', name: '350 GSM Imported Art Board', sku: 'RAW-PPR-350AB', category: 'Paper', unit: 'Sheets', currentStock: 4500, minStock: 1000, reorderLevel: 1500, purchasePrice: 4.8, supplier: 'Bilt Paper Traders (Delhi)', status: 'In Stock', updatedAt: '2026-09-14' },
  { id: 'inv-2', name: '400 GSM Super Velvet Cardstock', sku: 'RAW-PPR-400VC', category: 'Paper', unit: 'Sheets', currentStock: 850, minStock: 500, reorderLevel: 750, purchasePrice: 9.2, supplier: 'Bilt Paper Traders (Delhi)', status: 'In Stock', updatedAt: '2026-09-10' },
  { id: 'inv-3', name: '130 GSM Gloss Art Paper (A4 size)', sku: 'RAW-PPR-130GL', category: 'Paper', unit: 'Reams', currentStock: 45, minStock: 20, reorderLevel: 30, purchasePrice: 320, supplier: 'Bilt Paper Traders (Delhi)', status: 'In Stock', updatedAt: '2026-09-12' },
  { id: 'inv-4', name: 'Star Flex Heavy Duty 340 GSM (10ft Roll)', sku: 'RAW-FLX-340SF', category: 'Flex/Vinyl', unit: 'Roll', currentStock: 14, minStock: 5, reorderLevel: 8, purchasePrice: 3800, supplier: 'Pioneer Signage Media (Ludhiana)', status: 'In Stock', updatedAt: '2026-09-08' },
  { id: 'inv-5', name: 'Gloss White PVC Vinyl Roll (4ft x 50m)', sku: 'RAW-VNY-GLS4', category: 'Flex/Vinyl', unit: 'Roll', currentStock: 6, minStock: 4, reorderLevel: 5, purchasePrice: 2450, supplier: 'Pioneer Signage Media (Ludhiana)', status: 'In Stock', updatedAt: '2026-09-02' },
  { id: 'inv-6', name: '38 GSM Greaseproof Food Butter Paper', sku: 'RAW-BTR-38GP', category: 'Paper', unit: 'Sheets', currentStock: 18000, minStock: 5000, reorderLevel: 8000, purchasePrice: 0.65, supplier: 'Krishna Food Packaging Supplies', status: 'In Stock', updatedAt: '2026-09-05' },
  { id: 'inv-7', name: '5mm Rigid PVC Sunboard (8ft x 4ft Sheets)', sku: 'RAW-SNB-5MM', category: 'Board', unit: 'Sheets', currentStock: 32, minStock: 15, reorderLevel: 25, purchasePrice: 620, supplier: 'Chandigarh Foam & Sheet Distributors', status: 'In Stock', updatedAt: '2026-09-11' },
  { id: 'inv-8', name: 'Eco-Solvent Cyan Ink (1 Liter Bottle)', sku: 'RAW-INK-CYAN', category: 'Ink', unit: 'Bottle', currentStock: 8, minStock: 3, reorderLevel: 5, purchasePrice: 1250, supplier: 'Flora Inks India', status: 'In Stock', updatedAt: '2026-09-01' },
  { id: 'inv-9', name: 'Eco-Solvent Magenta Ink (1 Liter Bottle)', sku: 'RAW-INK-MAG', category: 'Ink', unit: 'Bottle', currentStock: 7, minStock: 3, reorderLevel: 5, purchasePrice: 1250, supplier: 'Flora Inks India', status: 'In Stock', updatedAt: '2026-09-01' },
  { id: 'inv-10', name: 'Eco-Solvent Yellow Ink (1 Liter Bottle)', sku: 'RAW-INK-YEL', category: 'Ink', unit: 'Bottle', currentStock: 2, minStock: 3, reorderLevel: 5, purchasePrice: 1250, supplier: 'Flora Inks India', status: 'Low Stock', updatedAt: '2026-09-15' },
  { id: 'inv-11', name: 'Executive Metal Pens (Matte Black Blanks)', sku: 'RAW-PEN-MTBLK', category: 'Packaging', unit: 'Pcs', currentStock: 450, minStock: 100, reorderLevel: 200, purchasePrice: 12.5, supplier: 'Delhi Corporate Souvenirs', status: 'In Stock', updatedAt: '2026-09-13' }
];

export const initialSuppliers: Supplier[] = [
  { id: 'sup-1', name: 'Bilt Paper Traders (Delhi)', contactPerson: 'Ramesh Gupta', phone: '+91 9811023456', email: 'sales@biltpaper.in', address: 'Chawri Bazar, Old Delhi, Delhi - 110006', gstin: '07AAACB1234D1Z5', category: 'Paper & Cardstock' },
  { id: 'sup-2', name: 'Pioneer Signage Media (Ludhiana)', contactPerson: 'Harpreet Singh', phone: '+91 9876543210', email: 'pioneer.signage@gmail.com', address: 'Industrial Area B, Ludhiana, Punjab - 141003', gstin: '03AABCP5678E1Z3', category: 'Flex & Vinyl Media' },
  { id: 'sup-3', name: 'Flora Inks India', contactPerson: 'Vijay Sharma', phone: '+91 9899112233', email: 'vijay@florainks.com', address: 'Noida Phase II, UP - 201305', gstin: '09AAACF9876K1ZP', category: 'Inks & Toners' }
];
...
export const initialCustomers: Customer[] = [
  {
    ...
    mobile: '9878012345',
    whatsapp: '9878012345',
    email: 'gurpreet@tricitylogistics.com',
    company: 'Tricity Logistics & Movers',
    address: 'SCF 42, Sector 22-C',
    city: 'Chandigarh',
    state: 'Chandigarh',
    pincode: '160022',
    totalOrders: 4,
  ...
  },
  {
    ...
    mobile: '9815098765',
    whatsapp: '9815098765',
    email: 'ananya@bakehousecafe.in',
    company: 'Bakehouse Artisan Cafe',
    address: 'Shop 18, Inner Market, Sector 7-C',
    city: 'Chandigarh',
    state: 'Chandigarh',
    pincode: '160019',
    totalOrders: 6,
  ...
  },
  {
    ...
    mobile: '9417034567',
    whatsapp: '9417034567',
    email: 'rohit.verma@vermaeyeclinic.com',
    company: 'Verma Advanced Eye Clinic',
    address: 'SCO 112, Phase 3B2',
    city: 'Mohali',
    state: 'Punjab',
    pincode: '160059',
    totalOrders: 2,
...
export const initialOrders: Order[] = [
  {
    ...
    customer: {
      ...
      email: 'ananya@bakehousecafe.in',
      company: 'Bakehouse Artisan Cafe',
      billingAddress: 'Shop 18, Inner Market, Sector 7-C',
      deliveryAddress: 'Shop 18, Inner Market, Sector 7-C',
      city: 'Chandigarh',
      state: 'Chandigarh',
      pincode: '160019'
    },
    items: [
      {
        id: 'item-1',
        productId: 'prod-bp-01',
        productName: 'Custom Printed Butter Paper Sheets',
        category: 'Butter Paper Printing',
        image: '/images/products/butter-paper-sheets.jpg',
        quantity: 2500,
        unitPrice: 1.8,
        selectedOptions: [
          { groupName: 'Sheet Size', valueName: '12 x 12 Inches (Medium Wrap)', priceModifier: 400 },
          { groupName: 'Print Colors', valueName: 'Single Color (Red, Brown, Black or Blue)', priceModifier: 0 }
        ],
        customNotes: 'Please print logo in chocolate brown shade Pantone 476C',
        subtotal: 4900
      }
    ],
    subtotal: 4900,
    ...
    specialInstructions: 'Deliver between 11 AM - 3 PM before cafe rush.',
    paymentStatus: 'Advance Paid',
    paymentMethod: 'UPI / QR Code',
    orderStatus: 'In Production',
    statusHistory: [
      { status: 'New', timestamp: '2026-09-15 10:14:00', updatedBy: 'System', notes: 'Order placed by customer online' },
      { status: 'Confirmed', timestamp: '2026-09-15 10:30:00', updatedBy: 'Admin (PrintezYour)', notes: 'Advance received ₹3000 via UPI' },
      { status: 'Artwork Approved', timestamp: '2026-09-15 11:45:00', updatedBy: 'Admin (PrintezYour)', notes: 'Client confirmed PDF proof on WhatsApp' },
      { status: 'In Production', timestamp: '2026-09-15 14:00:00', updatedBy: 'Staff (Shop Floor)', notes: 'Plate mounted on 2-color press' }
    ],
  ...
  },
  {
    ...
    customer: {
      ...
      email: 'gurpreet@tricitylogistics.com',
      company: 'Tricity Logistics & Movers',
      billingAddress: 'SCF 42, Sector 22-C',
      deliveryAddress: 'SCF 42, Sector 22-C',
      city: 'Chandigarh',
      state: 'Chandigarh',
      pincode: '160022'
    },
    items: [
      {
        id: 'item-2',
        productId: 'prod-vc-01',
        productName: 'Premium Matte Laminated Visiting Cards',
        category: 'Visiting Cards',
        image: '/images/products/visiting-cards-matte.jpg',
        quantity: 1000,
        unitPrice: 1.8,
        selectedOptions: [
          { groupName: 'Printing Sides', valueName: 'Front & Back Printing', priceModifier: 150 },
          { groupName: 'Corner Style', valueName: 'Standard Square Cut', priceModifier: 0 },
          { groupName: 'Premium Finishing', valueName: 'Thermal Matte Lamination', priceModifier: 0 }
        ],
        subtotal: 1950
      },
      {
        id: 'item-3',
        productId: 'prod-stk-01',
        ...
        unitPrice: 2.9,
        selectedOptions: [
          { groupName: 'Sticker Size', valueName: '3 x 3 Inches (Standard)', priceModifier: 150 },
          { groupName: 'Finish Type', valueName: 'Gloss Waterproof Vinyl', priceModifier: 50 }
        ],
        subtotal: 1650
      }
    ],
    ...
    totalAmount: 4130,
    deliveryType: 'Pickup',
    specialInstructions: 'Will collect in person from Hallo Majra office.',
    paymentStatus: 'Fully Paid',
    paymentMethod: 'UPI / QR Code',
    orderStatus: 'Ready',
    statusHistory: [
      { status: 'New', timestamp: '2026-09-14 11:20:00', updatedBy: 'System', notes: 'Order created' },
      { status: 'Confirmed', timestamp: '2026-09-14 11:35:00', updatedBy: 'Admin', notes: 'Full payment verified' },
      { status: 'Artwork Approved', timestamp: '2026-09-14 12:10:00', updatedBy: 'Admin', notes: 'Vector files checked' },
      { status: 'In Production', timestamp: '2026-09-14 13:00:00', updatedBy: 'Staff', notes: 'Printing completed' },
      { status: 'Quality Check', timestamp: '2026-09-14 16:30:00', updatedBy: 'Staff', notes: 'Lamination and cutting inspected' },
      { status: 'Pickup Ready', timestamp: '2026-09-14 17:00:00', updatedBy: 'Admin', notes: 'Customer notified to collect' }
    ],
...
export const initialQuotes: QuoteRequest[] = [
  {
    ...
    email: 'simran.chandigarh@gmail.com',
    phone: '9888123456',
    whatsapp: '9888123456',
    company: 'Amrit Banquet & Events',
    serviceCategory: 'Flex & Banner Printing',
    productRequirement: 'Backdrop flex for 3-day Punjabi Wedding expo, size 24ft x 12ft, with star flex and matte lamination to prevent stage light glare.',
    quantity: 1,
    sizeSpecs: '24ft width x 12ft height (288 sq ft)',
    materialPreference: 'Star Flex with Black Backing',
    finishPreference: 'Matte Lamination / Anti-Glare',
    deliveryNeededBy: '2026-09-22',
    status: 'New',
    quotedPrice: 3800,
    adminNotes: 'Check if installation on iron frame in Zirakpur is needed.',
  ...
  },
  {
    ...
    email: 'mittal.pharma@yahoo.com',
    phone: '9872045678',
    whatsapp: '9872045678',
    company: 'Mittal Herbal Formulations',
    serviceCategory: 'Boxes & Packaging',
    productRequirement: 'Mono carton boxes for 100ml syrup glass bottles with gold foil logo and inner partition.',
    quantity: 5000,
    sizeSpecs: '65mm x 65mm x 140mm',
    materialPreference: '350 GSM Cyber Premium Board',
    finishPreference: 'Thermal Matte + Gold Hot Stamping',
    deliveryNeededBy: '2026-09-30',
    status: 'Quotation Sent',
    quotedPrice: 26500,
    adminNotes: 'Formal quote shared on WhatsApp. Followup scheduled for tomorrow.',
